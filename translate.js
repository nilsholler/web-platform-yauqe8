...
function translateEnglish(){
  ...
  $("#privacyCheckboxLabel").html('I accept the <a class="text-info" href="">information on data processing</a>.');
}
...
function translateGerman(){
  ...
  $("#privacyCheckboxLabel").html('Ich akzeptiere die <a class="text-info" href="">Hinweise zur Datenverarbeitung</a>.');
}